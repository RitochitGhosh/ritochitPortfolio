...
const Card = ({ props }) => {
  ...
  return (
    <div className="w-[230px] h-auto rounded-xl duration-200 ease-in-out hover:scale-105 flex flex-col justify-between p-4 shadow-md overflow-hidden bg-white transform transition-transform">
        ...
        <div className="flex flex-wrap justify-between gap-2 mt-auto">
          ...
          {props.link && (
            <button
              ...
              className="rounded-md bg-[#15023a] text-white font-semibold shadow-md hover:shadow-lg duration-200 ease-in-out px-2 py-1 text-xs hover:bg-[#fafbf8] hover:text-[#15023a] border-2 border-transparent hover:border-[#15023a]"
            >
              Link
            </button>
          )}
